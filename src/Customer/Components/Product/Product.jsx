...
export default function Product() {
    ...
    const serachParams=new URLSearchParams(decodedQueryString);

    const color=serachParams.get("color");
    const size=serachParams.get("size");
    const price=serachParams.get("price");
    const discount=serachParams.get("discount");
    const sort=serachParams.get('sort');
    const pageNumber=serachParams.get("page") || 1;
    const stock=serachParams.get("stock");
    ...
    },[param.lavelThree,color,size,price,discount,sort,pageNumber,stock])
    return (
